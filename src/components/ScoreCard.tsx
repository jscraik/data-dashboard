...
export function ScoreCard({
  ...
  return (
    <div 
      className={`card ${statusColors[status]} animate-entrance transition-all duration-fast ease-standard hover:-translate-y-0.5 hover:shadow-md`}
      ...
      <div className="card-body">
        <div className="flex items-start justify-between">
          <div>
            ...
            {trend && trendValue && (
              <div className={`flex items-center gap-1 mt-2 text-sm transition-transform duration-fast hover:translate-x-0.5 ${
          ...
          <div className={`p-2 bg-slate-100 rounded-lg transition-all duration-fast group-hover:bg-slate-200 ${iconColors[status]}`}>
